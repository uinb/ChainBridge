...
import (
	...
	ethChain "github.com/uinb/ChainBridge/chains/ethereum"
	subChain "github.com/uinb/ChainBridge/chains/substrate"
	eth "github.com/uinb/ChainBridge/e2e/ethereum"
	sub "github.com/uinb/ChainBridge/e2e/substrate"
	"github.com/uinb/ChainBridge/shared"
	ethutils "github.com/uinb/ChainBridge/shared/ethereum"
	ethtest "github.com/uinb/ChainBridge/shared/ethereum/testing"
	subutils "github.com/uinb/ChainBridge/shared/substrate"
...
func createAndStartBridge2(t *testing.T, name string, contractsA *ethutils.DeployedContracts) (*core.Core, log.Logger) {
	// Create logger to write to a file, and store the log file name in global var
	logger := log.Root().New()
	sysErr := make(chan error)
	ethACfg := eth.CreateConfig(name, EthAChainId, contractsA, eth.EthAEndpoint)
...
func Test_ThreeRelayers(t *testing.T) {
	...
	// bridgeA, bobLog := createAndStartBridge2(t, "bob", contractsA)
